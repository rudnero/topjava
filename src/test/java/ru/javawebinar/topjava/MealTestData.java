...
public class MealTestData {
    ...
    public static final Meal USER_MEAL_6 = new Meal(USER_MEAL_ID_6, LocalDateTime.of(2015, Month.MAY, 31, 10, 0), "Завтрак", 1000);
    public static final Meal USER_MEAL_7 = new Meal(USER_MEAL_ID_7, LocalDateTime.of(2015, Month.MAY, 31, 13, 0), "Обед", 500);
    ...
    public static final Meal ADMIN_MEAL_12 = new Meal(ADMIN_MEAL_ID_12, LocalDateTime.of(2015, Month.MAY, 31, 10, 0), "Завтрак", 1000);
    public static final Meal ADMIN_MEAL_13 = new Meal(ADMIN_MEAL_ID_13, LocalDateTime.of(2015, Month.MAY, 31, 13, 0), "Обед", 500);
